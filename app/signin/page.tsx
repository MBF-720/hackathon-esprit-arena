...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 relative overflow-hidden font-sans text-white py-8">
      <div className="relative z-10 w-[95%] sm:w-full max-w-md mx-auto">
        
        {/* 2. Modern Hackathon Header */}
        <div className="mb-8 md:mb-10 flex flex-col items-center">
          <div className="relative mb-4">
            {/* The Main Brain/Gear Modern SVG */}
            <svg className="w-16 h-16 md:w-20 md:h-20 text-cyan-400 drop-shadow-[0_0_15px_rgba(34,211,238,0.5)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 md:p-8 rounded-[1.5rem] md:rounded-[2rem] shadow-2xl relative">
          {/* Corner Accent */}
